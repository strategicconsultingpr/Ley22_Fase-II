<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPerfil.master" AutoEventWireup="true" CodeBehind="sepsEvaluacion.aspx.cs" Inherits="Ley22_WebApp_V2.sepsEvaluacion" %>
...
<%@ Register Src="~/Perfiles/wucDatosEvaluacion.ascx" TagPrefix="uc1" TagName="wucDatosEvaluacion" %>
                   ...
                   <h1 style="display:inline">Perfil de evaluación </h1> <h2 style="display:inline"><asp:Label ID="lblTipoPerfil" runat="server" ></asp:Label></h2>
                    ...
                    <div>
                     <%--   <uc1:wucDatosPersonales ID="wucDatosPersonales" runat="server" />--%>
                        ...
                        <br />
                        <uc1:wucDatosEvaluacion runat="server" id="wucDatosEvaluacion" />
                    </div>
                       </div>

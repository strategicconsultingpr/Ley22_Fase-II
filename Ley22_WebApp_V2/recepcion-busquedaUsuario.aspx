    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" AutoGenerateColumns="False" PagerSettings-Visible="false" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting" GridLines="None" CellSpacing="-1" DataKeyNames="Id_Participante">
                    <Columns>
